...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <form action="../controller/login_controller.php?status=verify-otp" method="post">
                <div class="row" style="height:500px;">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 panel panel-default login-panel" style="height:100%;border-radius:0px 35px 35px 0px;   box-shadow: 10px 10px 10px grey" >
                        ...
                        <div class="row">
                            <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <label style="font-size:15px">Enter The One Time Password Received</label>  
                        </div>
                        <div class="row">
                            &nbsp;
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <input type="submit" name="submit" class="btn btn-primary btn-block" style="background-color:#0d778a" value="Verify"/>
                            </div>
                        </div>
                        <div class="row">
                            &nbsp;
